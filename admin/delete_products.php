<html><body>
   	    <h2 align="right">Delete Product &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="adminhome.php?view=add_products"><input name="" type="button" value="Back"></a></h2>
<?php
session_start();
...
mysql_query("delete from product where p_id='$id'");
...
?>
        ...
        <td><a href="adminhome.php?view=delete_products&id=<?php echo $r['p_id'];?>&amp;f=delete">Delete</a></td>
