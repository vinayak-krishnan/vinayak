...
$df="SELECT * FROM complaints where year(check_date)='$n' and solv_mgr='$mg_id' and solv_ex='$ex_id'";
...
<div class="templatemo_box">
   	    <h2 align="right">Yearly WorkFlow&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="adminhome.php?view=ayearly"><input name="" type="button" value="Back"></a></h2>
<table border="0" width="99%" bgcolor="#FFE6F2">
<tr>
  
<th width="8%">Year:</th><th width="10%"><?php echo $n;?></th>
<th width="16%">Manager Name:</th><th width="10%"><?php echo $mgna;?></th>
<th width="19%">Executive Name:</th><th width="19%"><?php echo $exna;?></th>
</tr>
</table>
<br>
