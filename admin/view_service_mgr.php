...
$h=$_POST['mail'];	
 ...
 mysql_query("update service_mgr set mgr_name='$a',mgr_gender='$c',mgr_add='$b',mgr_phone='$g',mgr_email='$h' where mgr_id='$id'");
...
<body>
 <div class="templatemo_box">
   	    <h2 align="center">Update Service Manager</h2>
...
<?php
 ...
 $s1=mysql_query("select * from service_mgr where mgr_id='$id'");	
...
<form action="" method="post" name="form1" id="form1">
 <center> <table width="515" height="441" border="0">
    ...
    <tr>
      ...
      <td><textarea name="address" id="address" cols="30" rows="5" size="40" ><?php echo $r['mgr_add']; ?></textarea></td>
    </tr>
    <tr>
      <td>Gender</td>
     <td>
